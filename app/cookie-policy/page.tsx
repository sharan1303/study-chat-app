...
export const metadata: Metadata = {
  ...
  description: "Cookie Policy for Study Chat platform",
};
          ...
          <div className="text-foreground/90">
            ...
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground leading-relaxed">
                This Cookie Policy explains how Study Chat (&quot;Company,&quot;
                &quot;we,&quot; &quot;us,&quot; and &quot;our&quot;) uses
            ...
            <div className="space-y-4 mt-10">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Cookies set by the website owner (in this case, Study Chat) are
                    ...
                    <table className="w-full text-sm">
                      <tbody>
                        <tr className="border-b border-border/40">
                          <td className="py-2 font-medium text-right pr-4 w-1/4 text-foreground/80">
                            Name:
                          </td>
                          <td className="py-2 text-muted-foreground">s7</td>
                        </tr>
                        <tr className="border-b border-border/40">
                          <td className="py-2 font-medium text-right pr-4 w-1/4 text-foreground/80">
                            Purpose:
            ...
            <div className="space-y-4 mt-10">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                your browser&apos;s help menu for more information. The
                following is information about how to manage cookies on the most
                popular browsers:
              </p>
            ...
            <div className="space-y-4 mt-10">
              ...
              <p className="text-sm font-medium">
                <a
                  href="mailto:support@mystudy.chat"
                  className="text-primary hover:underline"
                >
                  support@mystudy.chat
                </a>
              </p>
            </div>
          </div>
