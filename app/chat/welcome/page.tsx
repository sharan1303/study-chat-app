...
// Cache the welcome chat ID lookup to avoid redundant DB queries
const getOrCreateWelcomeChatId = cache(
  async (userId: string | null, sessionId: string | null): Promise<string> => {
