    ...
    <div className="h-full flex flex-col py-3">
      ...
      <div className="flex justify-between items-center mt-0.5 ml-5 pr-6">
        <Button
          ...
          size="sm"
          asChild
          className="flex add-margin-for-headers items-center"
        >
          <Link href="/">
          ...
          <div className="text-foreground/90">
            ...
            <div className="space-y-4 mt-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                registered in the United Kingdom at 3 Bloomfield Road, Bristol
                BS4 3QA.
              </p>
              <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                (&apos;you&apos;), and Sharan Govinden Umavassee, concerning
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                continued use of changes in any revised Legal Terms by your
            ...
            <div className="space-y-4 mt-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                sharan.umavassee@gmail.com. If we ever grant you the permission
            ...
            <div className="space-y-4 mt-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                any illegal or unauthorised purpose; and (8) your use of the
            ...
            <div className="space-y-4 mt-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                Privacy Policy: mystudy.chat/privacy-policy. By using the
            ...
            <div className="space-y-4 mt-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                country to residence. Sharan Govinden Umavassee and yourself
                both agree to submit to the non-exclusive jurisdiction of the
                courts of Greater London, which means that you may make a claim
            ...
            <div className="space-y-4 mt-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                expressly provided below) informally for at least __________
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                constitutes acceptance. The seat of arbitration shall be the
                United Kingdom. The language of the proceedings shall be
                __________. Applicable rules of substantive law shall be the law
            ...
            <div className="space-y-4 mt-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1)
                MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR . CERTAIN
