...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for Study Chat platform",
};
        ...
        <div className="text-foreground/90">
          ...
          <div className="space-y-4 mt-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              We are Sharan Govinden Umavassee (&apos;Company&apos;,
              &apos;we&apos;, &apos;us&apos;, or &apos;our&apos;), a company
              registered in the United Kingdom at 3 Bloomfield Road, Bristol BS4
              3QA.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              AI Chat application for students
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              You can contact us by phone at 07367620020, email at{" "}
              <a
                href="mailto:sharan.umavassee@gmail.com"
                className="text-primary hover:underline"
              >
                sharan.umavassee@gmail.com
              </a>
              , or by mail to 3 Bloomfield Road, Bristol BS4 3QA, United
              Kingdom.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity
              (&apos;you&apos;), and Sharan Govinden Umavassee, concerning your
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              use of changes in any revised Legal Terms by your continued use of
          ...
          <div className="space-y-4 mt-8">
            ...
            <ol className="list-decimal pl-10 text-sm text-muted-foreground space-y-2">
              <li>OUR SERVICES</li>
          ...
          <div className="space-y-4 mt-8">
            <h2 className="text-xl font-semibold tracking-tight" id="services">
              1. OUR SERVICES
            </h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-4 mt-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              photographs, and graphics in the Services (&apos;Content&apos;),
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              Terms, please address your request to: sharan.umavassee@gmail.com.
          ...
          <div className="space-y-4 mt-8">
            <h2 className="text-xl font-semibold tracking-tight" id="purchases">
          ...
          <div className="space-y-4 mt-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              Policy: mystudy.chat/privacy-policy. By using the Services, you
              ...
              in the United Kingdom. If you access the Services from any other
              region of the world with laws or other requirements governing
              personal data collection, use, or disclosure that differ from
              applicable laws in the United Kingdom, then through your continued
              use of the Services, you are transferring your data to the United
              Kingdom, and you expressly consent to have your data transferred
          ...
          <div className="space-y-4 mt-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              country to residence. Sharan Govinden Umavassee and yourself both
              agree to submit to the non-exclusive jurisdiction of the courts of
              Greater London, which means that you may make a claim to defend
          ...
          <div className="space-y-4 mt-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              of arbitration shall be the United Kingdom. The language of the
              proceedings shall be __________. Applicable rules of substantive
              law shall be the law of the United Kingdom.
            </p>
            <h3 className="text-lg font-medium tracking-tight">Restrictions</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-4 mt-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1) MONTH
              PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR . CERTAIN US STATE
          ...
          <div className="space-y-4 mt-8">
            <h2 className="text-xl font-semibold tracking-tight" id="user-data">
              21. USER DATA
            </h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
